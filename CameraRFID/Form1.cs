...
namespace CameraRFID
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void ReadModbusRegisters()
        {
            try
            {
                ...
                if (checkFinishMeasure == 1)
                {
                    ...
                    //입력값 확인 1
                    if (measureWormWeight == 0)
                    {
                        MessageBox.Show("곤충 무게값을 입력해 주십시오.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    ...
                    diary.updateDiary("GROWTH", cardreader.getCardNumber(), measureCO2 :measureCO2, measureNH3 : measureNH3, measureTEMP : measureTEMP, measureHUMID : measureHUMID, measureWormWeight : measureWeight, selectInstarName : instarName);
        ...
        //곤충 무게 입력시 숫자와 소수점만 입력 가능하게..
        private void WormWeightValidation(object sender, KeyPressEventArgs e)
        {
        ...
        //곤충 무게 입력값 저장
        private void updateWormWeight(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(input_wormWeight.Text))
            {
